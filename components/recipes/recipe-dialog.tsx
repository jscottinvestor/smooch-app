  ...
  return (
    <div className="rounded-md border border-border bg-muted/20 p-2 space-y-1.5 min-w-0 max-w-full">
      <div className="flex items-center gap-1.5 min-w-0 max-w-full">
        ...
        >
          <SelectTrigger size="sm" className="h-8 w-20 text-xs shrink-0">
            <SelectValue />
          </SelectTrigger>
          <SelectContent>
            {ALL_UNITS.map((u) => (
      ...
      <div className="flex items-center gap-1.5 pl-1 min-w-0">
        ...
        <Select
          ...
          items={filterItems}
        >
          <SelectTrigger size="sm" className="h-8 flex-1 min-w-0 text-xs">
            <SelectValue />
          </SelectTrigger>
          <SelectContent>
      ...
      <div className="flex items-center gap-1.5 pl-1 min-w-0">
        ...
        >
          <SelectTrigger
            size="sm"
            className="h-8 flex-1 min-w-0 text-xs data-placeholder:italic"
          >
